...
// import fr.formation.filmsservice.api.response.CategorieResponse;
...
public class FilmApiController {
    ...
    public List<Film> findAll() {
        return this.srvFilm.findAll();
    }

    @GetMapping("/{id}")
    public FilmDetailsResponse findById(@PathVariable int id) {
        Film film = this.srvFilm.findById(id);
        Categorie categorie = this.srvFilm.findCatById(film.getCategorie());
